 ...
 */
final class Version20190726092548 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hotel DROP room_capacity_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hotel ADD room_capacity_id INT DEFAULT NULL');
